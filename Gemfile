...
gem 'assembly-objectfile', :git => 'corn.stanford.edu:/afs/ir/dev/dlss/git/lyberteam/assembly-objectfile.git'
gem 'version_bumper', :git => 'https://github.com/drh-stanford/version_bumper.git', :branch => 'patch_tag'
gem 'druid-tools', :git => 'https://github.com/sul-dlss/druid-tools'
